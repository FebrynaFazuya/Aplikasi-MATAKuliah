...
$id =  $_GET['id'];
$data2 = mysqli_query($db, "SELECT * from pertemuan WHERE id_pertemuan ='$id'");
                ...
                <div id="html-validations" class="card card-tabs">
                    <div class="card-content">
                        ...
                        <div id="html-view-validations">
                            <form class="formValidate0" id="formValidate0" method="POST" action="fungsi/editPertemuan.php">
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input class="validate" required id="uname0" name="id" type="text" value="<?= $data3['id_pertemuan']; ?>" hidden>
                                        <input class="validate" required id="uname0" name="id_kode_mata_kuliah" type="text" value="<?= $data3['id_kode_mata_kuliah']; ?>" hidden>
                                        <input class="validate" required id="uname0" name="judul" type="text" value="<?= $data3['judul']; ?>">
                                    </div>
                                    <div class="input-field col s12">
                                        <input class="validate" required id="cemail0" type="text" name="pertemuan_ke" value="<?= $data3['pertemuan_ke']; ?>">
                                    </div>
                                    <div class="input-field col s12">
                                        <input class="validate" required id="password0" type="text" name="deskripsi_pertemuan" value="<?= $data3['deskripsi_pertemuan']; ?>">
                                    </div>
                                    ...
                                    <div class="input-field col s12">
                                        ...
                                        <a href="detail.php?id=<?= $data3['id_kode_mata_kuliah']; ?>" class="btn waves-effect waves-light right green darken-1" style="margin-right: 10px;">Kembali
